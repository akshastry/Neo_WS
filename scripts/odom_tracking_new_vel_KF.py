...
def aruco_callback(data):
	...
	global sigma_P2_x, sigma_M2_x, sigma_P2_y, sigma_M2_y, sigma_P2_z, sigma_M2_z
	global aruco_ctr

	dt1 = rospy.get_time() - aruco_detect_time
	aruco_detect_time = rospy.get_time()
	aruco_ctr = aruco_ctr + 1
	...
	if(autonomy_mode == True):
		...
		x_k_x, P_k_x = Kalman_Filter1(x_k_x, P_k_x, 0.0, X_t1, sigma_P2_x, sigma_M2_x, dt1)
