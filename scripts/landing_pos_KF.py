...
Kp_x = 4.0#0.5#0.2#2.5
Kd_x = 2.7#0.001
Ki_x = 0.02

Kp_y = 4.0#0.5#0.2#2.5
Kd_y = 2.7#0.001
Ki_y = 0.02
...
def pos_vel_callback(data):
	...
	X = (1.0 - LP_X) * X + LP_X * (data.linear.x + 0.155*(1.0 - np.cos(yaw)*np.cos(pitch)) );
	Y = (1.0 - LP_Y) * Y + LP_Y * (data.linear.y - 0.155*np.sin(yaw)*np.cos(pitch));
